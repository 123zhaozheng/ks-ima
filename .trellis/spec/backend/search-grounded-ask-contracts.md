...
5. Owner/privacy, membership revoke races, conversation optimistic conflicts, citation stability/deletion, and concurrent index build tests run on PostgreSQL.
